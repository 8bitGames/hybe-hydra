/**
 * Fast Cut Effect Analyzer Agent
 * ==============================
...
// Input Schema
export const FastCutEffectAnalyzerInputSchema = z.object({
  prompt: z.string(),
  bpm: z.number().optional(),
  existingVibe: z.enum(['Exciting', 'Emotional', 'Pop', 'Minimal']).optional(),
});

export type FastCutEffectAnalyzerInput = z.infer<typeof FastCutEffectAnalyzerInputSchema>;
...
// Output Schema
export const FastCutEffectAnalyzerOutputSchema = z.object({
...
export type FastCutEffectAnalyzerOutput = z.infer<typeof FastCutEffectAnalyzerOutputSchema>;

// Agent Configuration
export const FastCutEffectAnalyzerConfig: AgentConfig<FastCutEffectAnalyzerInput, FastCutEffectAnalyzerOutput> = {
...
Suggested Color Grades: natural, vibrant, cinematic, moody, bright, warm, cool, vintage, neon, dramatic`,
  ...
  inputSchema: FastCutEffectAnalyzerInputSchema,
  outputSchema: FastCutEffectAnalyzerOutputSchema,
};

/**
 * Fast Cut Effect Analyzer Agent Implementation
 */
export class FastCutEffectAnalyzerAgent extends BaseAgent<FastCutEffectAnalyzerInput, FastCutEffectAnalyzerOutput> {
  constructor() {
    super(FastCutEffectAnalyzerConfig);
  }

  protected buildPrompt(input: FastCutEffectAnalyzerInput, context: AgentContext): string {
  ...
  async analyzePrompt(
    ...
    options?: {
      bpm?: number;
      existingVibe?: FastCutEffectAnalyzerInput['existingVibe'];
    }
  ) {
    return this.execute(
      {
   ...
   */
  fallbackAnalysis(prompt: string): FastCutEffectAnalyzerOutput {
...
// Factory function
export function createFastCutEffectAnalyzerAgent(): FastCutEffectAnalyzerAgent {
  return new FastCutEffectAnalyzerAgent();
}
