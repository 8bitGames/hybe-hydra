...
export const ComposeConductorInputSchema = z.object({
  // Context information
...
export type ComposeConductorInput = z.infer<typeof ComposeConductorInputSchema>;
...
export const ComposeConductorOutputSchema = z.object({
  // Composition plan
...
export type ComposeConductorOutput = z.infer<typeof ComposeConductorOutputSchema>;

// ============================================================================
// Agent Configuration
// ============================================================================

export const ComposeConductorConfig: AgentConfig<ComposeConductorInput, ComposeConductorOutput> = {
  id: 'compose-conductor',
  ...
  inputSchema: ComposeConductorInputSchema,
  outputSchema: ComposeConductorOutputSchema,
...
export class ComposeConductorAgent extends BaseAgent<ComposeConductorInput, ComposeConductorOutput> {
  constructor() {
    super(ComposeConductorConfig);
  }
   ...
   */
  async analyzeImages(
    images: ComposeConductorInput['images'],
   ...
   */
  async analyzeLyrics(
    lyrics: ComposeConductorInput['lyrics'],
    context: AgentContext
  ): Promise<ComposeConductorOutput['lyricsAnalysis']> {
    ...
    try {
      ...
      console.error('[ComposeConductor] Lyrics analysis failed:', error);
      return {
        emotionalArc: [{ section: 'full', emotion: 'neutral', intensity: 0.5 }],
        keyMoments: [],
        themes: [],
   ...
   */
  protected buildPrompt(input: ComposeConductorInput): string {
...
export function createComposeConductorAgent(): ComposeConductorAgent {
  return new ComposeConductorAgent();
}
