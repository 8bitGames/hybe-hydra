...
// AI Video style presets - Subtle variations (1 preset = 1 video, minor modifications only)
// Categories: camera (앵글), movement (움직임), color (색상)
const AI_STYLE_PRESETS = [
  // Camera Variations - 카메라 앵글/위치 변경
  {
    id: "camera_closeup",
    name: "Close-up",
    nameKo: "클로즈업",
    description: "Close-up shot framing",
  ...
  // Movement Variations - 카메라 움직임 변경
  {
    id: "move_dolly_in",
    name: "Dolly In",
    nameKo: "돌리 인",
    description: "Slow push towards subject",
    descriptionKo: "피사체로 천천히 다가감",
    icon: Rocket,
    category: "movement",
  },
  {
