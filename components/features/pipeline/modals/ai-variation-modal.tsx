...
// Style categories for AI variation
...
export interface AIVariationConfig {
...
interface AIVariationModalProps {
  ...
  presets: StylePreset[];
  onCreateVariations: (config: AIVariationConfig) => Promise<void>;
  isCreating: boolean;
  socialAccounts?: SocialAccount[];
}

// Category configuration for AI (Veo) generation
const AI_VARIATION_CATEGORIES = [
  {
    id: "mood",
    name: "Mood",
    nameKo: "분위기",
...
export function AIVariationModal({
  isOpen,
  onClose,
  seedGeneration,
  presets,
  ...
  const handleCreate = async () => {
    ...
    const config: AIVariationConfig = {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {isKorean ? "AI 변형 생성" : "Create AI Variations"}
          </DialogTitle>
          <DialogDescription>
            {isKorean
        ...
        <div className="flex-1 overflow-y-auto space-y-6 py-4">
          ...
          <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <Badge variant="outline" className="text-xs shrink-0 border-blue-500/30">Prompt</Badge>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {AI_VARIATION_CATEGORIES.map((category) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      />
                      <Icon className={`w-4 h-4 ${isSelected ? "text-blue-500" : "text-muted-foreground"}`} />
          ...
          <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-4">
            <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {selectedCategories.length === 0
                    ...
                    : selectedCategories.map((cat) => {
                        const category = AI_VARIATION_CATEGORIES.find((c) => c.id === cat);
              ...
              <div className="text-right">
                <p className="text-3xl font-bold text-blue-500">{estimatedVariations}</p>
                <p className="text-xs text-muted-foreground">
                  {isKorean ? "영상" : "videos"}
                </p>
              </div>
          ...
          >
            {isCreating ? (
              ...
              <>
                ...
                {isKorean
                  ? `${estimatedVariations}개 AI 변형 생성`
                  : `Generate ${estimatedVariations} AI Variations`}
              </>
            )}
          </Button>
        </DialogFooter>
