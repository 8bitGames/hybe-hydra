      ...
      report: {
        ...
        accounts: report.accounts.map(a => ({
          ...
          analysisData: {
            ...
            verified: a.analysis.verified,
            followers: Number(a.analysis.followers),
            videosAnalyzed: a.analysis.videosAnalyzed,
            basicMetrics: a.analysis.basicMetrics,
            engagementMetrics: a.analysis.engagementMetrics,
            aiInsights: a.analysis.aiInsights,
            contentMixMetrics: a.analysis.contentMixMetrics,
            videoClassifications: a.analysis.videoClassifications.map(vc => ({
              id: vc.id,
              tiktokVideoId: vc.tiktokVideoId,
              videoUrl: vc.videoUrl,
              thumbnailUrl: vc.thumbnailUrl,
              description: vc.description,
              playCount: Number(vc.playCount),
              ...
              shareCount: vc.shareCount,
              engagementRate: vc.engagementRate,
              aiCategories: vc.aiCategories,
              aiConfidence: vc.aiConfidence,
              reasoning: vc.reasoning,
              musicTitle: vc.musicTitle,
              isOwnMusic: vc.isOwnMusic,
              publishedAt: vc.publishedAt?.toISOString(),
              duration: vc.duration,
              contentAnalysis: vc.contentAnalysis,
            })),
          },
        })),
      },
