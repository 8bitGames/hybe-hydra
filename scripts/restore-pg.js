...
async function main() {
  try {
    ...
    const videoCount = await client.query('SELECT COUNT(*) FROM video_generations');

    console.log(`\nTotal: ${assetCount.rows[0].count} assets, ${videoCount.rows[0].count} videos`);
